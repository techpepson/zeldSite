              ...
              >
                <div className="mix-blends">
                  ...
                  >
                    ...
                    allows you to reach a larger audience and increase your
                    online visibility.
                  </p>
                </div>
              </div>
              ...
              >
                <div className="mix-blends">
                  ...
                  <p className={`${landPageStyles.smallText} text-uniq`}>
                    ...
                    or services for sale. This not only increases sales, but
                    goes ahead to increase your customer base. You can go
                    further to show your testimonials to potential clients to
              ...
              >
                <div className="mix-blends">
                  ...
                  <p className={`${landPageStyles.smallText} text-uniq`}>
                    ...
                    with customers, as well as receiving feedbacks from them to
                    help build on your business.
                  </p>
                </div>
              </div>
            </Intersection>
          ...
          <div className={`${landPageStyles.statsStylesRow} mt-10`}>
            <Intersection>
              <div className="flex flex-col">
                ...
                <span>
                  We pride ourself on being the go-to partner for your business
            ...
            <Intersection>
              <div>
                ...
                <span>
                  ...
                  Zeld to handle your diverse development with the use of best
                  and quality tools as well as industry best practices.
                </span>
              </div>
            </Intersection>
            <Intersection>
              <div>
                ...
                <p>
                  ...
                  technology. We are a company providing diverse services from
                  web development, mobile application development, cctv
            ...
            <Intersection>
              <div>
                ...
                <span>
                  ...
                  can logde complaints, make suggestions as well contact
